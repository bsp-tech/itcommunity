...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/employees/register","/logout","/employees/profile/edit","/user/edit", "/employees","/projects").authenticated()//this means only authenticated users can access to logout
