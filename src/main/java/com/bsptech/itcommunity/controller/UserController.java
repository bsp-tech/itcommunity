...
public class UserController {
    ...
    public ModelAndView registerPost(ModelAndView modelAndView, @ModelAttribute @Valid User user, BindingResult result,RedirectAttributes redirectAttributes,HttpSession session) {
        if(result.hasErrors()) {
